    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      {plans.length === 0 ? (
        <div className="empty-state">
          ...
          <h3 className="mt-4 text-lg font-medium text-gray-900 dark:text-gray-100">No plans available</h3>
          <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Check back later for subscription options</p>
        </div>
      ) : (
