  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="space-y-8">
        <section>
          <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">Active Subscriptions</h2>
          {activeSubscriptions.length === 0 ? (
            ...
            <h3 className="mt-2 text-sm font-medium text-gray-900 dark:text-gray-100">No active subscriptions</h3>
            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Subscribe to a plan to get started</p>
              </div>
            </div>
          ) : (
              ...
              {activeSubscriptions.map((sub) => (
                <div key={sub.id} className="card">
                  <div className="card-body flex items-center justify-between">
                    <div>
                      <h3 className="font-medium text-gray-900 dark:text-gray-100">{sub.plan?.name}</h3>
        ...
        {pastSubscriptions.length > 0 && (
          <section>
            <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">Past Subscriptions</h2>
            <div className="space-y-4">
